  ...
  if(!session)return(
    <div style={{background:'#030712',minHeight:'100vh',display:'flex',alignItems:'center',justifyContent:'center',fontFamily:'system-ui,sans-serif',padding:'20px'}}>
      <div style={{background:'#0f172a',border:'1px solid #1e3a5f',borderRadius:'14px',padding:'40px 36px',width:'100%',maxWidth:'360px',textAlign:'center',boxShadow:'0 25px 60px rgba(0,0,0,0.6)'}}>
        ...
        <div style={{fontSize:'22px',fontWeight:'800',color:'#f1f5f9',marginBottom:'4px',letterSpacing:'-0.5px'}}>PitchTrack Pro</div>
        <div style={{fontSize:'12px',color:'#475569',marginBottom:'28px',fontWeight:'600',letterSpacing:'1px',textTransform:'uppercase'}}>Coaches Only</div>
        ...
        <input type="password" placeholder="Password" value={authPass} onChange={e=>setAuthPass(e.target.value)} onKeyDown={e=>e.key==='Enter'&&handleLogin()} style={{width:'100%',padding:'11px 12px',borderRadius:'7px',border:'1px solid #1e3a5f',background:'#060d1a',color:'#f1f5f9',fontSize:'14px',marginBottom:'18px',boxSizing:'border-box',outline:'none',display:'block'}}/>
